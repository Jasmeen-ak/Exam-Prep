              ...
              <tr key={msg._id}>
                ...
                <td style={{ minWidth: 250 }}>
                  ...
                  <div className="d-flex gap-1">
                    <button className="btn btn-sm mt-1" style={{backgroundColor: '#6366F1',color:'white'}} onClick={() => sendReply(msg._id)}>Send Reply</button>
                    <button className=" btn btn-sm btn-success mt-1" onClick={() => editReply(msg._id, msg.answer)}><i class="fa-solid fa-pen"></i>Edit Reply</button>
                    <button className="btn btn-sm btn-danger mt-1" onClick={() => deleteByAdmin(msg._id)}><i class="fa-solid fa-trash"></i>Delete</button>
                  </div>
                </td>
              </tr>
            ))
