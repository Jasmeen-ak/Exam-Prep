...
const Examination = () => {
  ...
  return (
    <div className="container-fluid p-0">
              ...
              {formData.questionDistribution.map((item, index) => (
                <div className="row mb-1" key={index}>
                  ...
                  <div className="col-md-2">
                    <button
                      type="button"
                      className="btn-delete p-2 rounded"
      ...
      <div className="card mt-2" style={{ border: "1px solid #6f42c1", width: "100%",marginLeft:"-20px" }}>
                  ...
                  {exams.map((exam, index) => (
                    <tr key={exam._id}>
                     ...
                     <td>{exam.sessionId?.name || 'N/A'}</td>
                      ...
                      <td>{exam.status}</td>
                      <td>
                        <button className="btn btn-success me-2" onClick={() => handleEdit(exam)}><i class="fa-solid fa-pen"></i>Edit</button>
                        <button className="btn btn-danger" onClick={() => handleDelete(exam._id)}><i class="fa-solid fa-trash"></i>Delete</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
