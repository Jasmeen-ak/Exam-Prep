        ...
        <div className="col-sm-12">
          <div
            ...
            <form onSubmit={handleSubmit} className="border p-2 rounded">
              ...
              <button type="submit" className="btn btn-light text-white  mt-1" style={{ background: "#6366F1 " }}>
            ...
            <tbody>
              {data.map((q, index) => (
                <tr key={q._id}>
                  ...
                  <td>
                    <button className="btn me-2 p-2 btn-success" onClick={() => handleEdit(q)}><i class="fa-solid fa-pen"></i>Edit</button>
                    <button className="btn p-2 btn-danger" onClick={() => handleDelete(q._id)}><i class="fa-solid fa-trash"></i>Delete</button>
                  </td>
                </tr>
              ))}
              {data.length === 0 && (
